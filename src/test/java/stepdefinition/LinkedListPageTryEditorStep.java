...
public class LinkedListPageTryEditorStep {
	...
	@Given("User is on {string} page after clicking its link in the Queue Page")
	public void user_is_on_page_after_clicking_its_link_in_the_queue_page(String string) {
...
//	}
	...
	@When("User click on Run button {string}")
	public void user_click_on_run_button(String string) {
